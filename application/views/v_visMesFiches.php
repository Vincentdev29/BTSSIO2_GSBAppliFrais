		...
		<?php
			foreach( $mesFiches as $uneFiche)
			{
				...
				if ($uneFiche['id'] == 'CR') {
					...
					$signeLink = anchor('c_visiteur/signeFiche/'.$uneFiche['mois'].'/'.$uneFiche['idVisiteur'], 'signer',  'title="Signer la fiche"  onclick="return confirm(\'Voulez-vous vraiment signer cette fiche ?\');"');
				}
