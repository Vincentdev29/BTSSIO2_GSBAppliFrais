...
class FunctionsLib extends CI_Model {
  ...
  /**
   * Retourne une date au format fourni par le naigateur

   * @param $maDate au format retourné par le navigateur
   * @return date au format que le navigateur fourni. Il n'y pas de modification.
  */
  function dateNoFormat($maDate){
    return $maDate;
  }
